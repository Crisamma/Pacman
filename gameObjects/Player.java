...
public class Player extends Controllable {
    ...
    private boolean winner = false; //variabile da ritornare per sapere se la partita è vinta. False = no; True = WIN!

    public char lastKey = 'p'; //char per settare l'ultimo tasto cliccato: P = stay; W = UP; S = DOWN; D = RIGT; S = LEFT
    ...
    public void handleDamage() {
        //in caso si viene mangiati, si ritorna alle coordinate iniziali, si sta fermi e si perde una vita
    ...
    public void stayMovement(){
        //nel caso non venga premuto alcun tasto, si utilizza il vecchio tasto per continuare il movimento
        switch(lastKey){
